...
install_terraform() {
  if [ $(command -v tfswitch) ]; then
    ...
    wget https://releases.hashicorp.com/terraform/0.15.5/terraform_0.15.5_darwin_amd64.zip -O /tmp/terraform_0.15.5_darwin_amd64.zip
    unzip -o /tmp/terraform_0.15.5_darwin_amd64.zip
